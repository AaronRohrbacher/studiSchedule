...
account = Teacher.create!(first_name: 'Teacher', last_name: 'McFoo', user_id: 2, school_id: 1, admin: false)

User.create!(email: 'student@student.com', password:'111111', school_id: 1)
Student.create!(first_name: 'Student', last_name: 'McBar', user_id: 3, school_id: 1, admin: false)
